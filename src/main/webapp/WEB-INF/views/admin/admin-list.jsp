        ...
        <div class="container-fluid">
            ...
            <div class="row mb-4">
                <div class="col-md-8">
                    ...
                    <p class="text-muted">View and manage all product subcategories</p>
                </div>
                <div class="col-md-4 text-end">
                    <a href="${pageContext.request.contextPath}/subcategory/add" class="btn btn-primary">
                            ...
                            <tr data-category="${sub.category.categoryId}" data-status="${sub.active ? 'active' : 'inactive'}">
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="${pageContext.request.contextPath}/subcategory/view/${sub.subCategoryId}" class="btn btn-sm btn-info" title="View">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="${pageContext.request.contextPath}/subcategory/edit/${sub.subCategoryId}" class="btn btn-sm btn-warning" title="Edit">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="#" class="btn btn-sm btn-success" title="View Products">
                                            <i class="fas fa-box"></i>
                                        </a>
                                        <a href="${pageContext.request.contextPath}/subcategory/toggle-status/${sub.subCategoryId}" 
                                        ...
                                        <a href="${pageContext.request.contextPath}/subcategory/delete/${sub.subCategoryId}" 
